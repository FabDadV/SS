...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
         ...
         * Weather Icon *
         ****************/
        int weatherId = mCursor.getInt(SunshineFirebaseJobService.MainActivity.INDEX_WEATHER_CONDITION_ID);
        int weatherImageId;
        ...
        long dateInMillis = mCursor.getLong(SunshineFirebaseJobService.MainActivity.INDEX_WEATHER_DATE);
        ...
        double highInCelsius = mCursor.getDouble(SunshineFirebaseJobService.MainActivity.INDEX_WEATHER_MAX_TEMP);
         /*
        ...
        double lowInCelsius = mCursor.getDouble(SunshineFirebaseJobService.MainActivity.INDEX_WEATHER_MIN_TEMP);
         /*
          * If the user's preference for weather is fahrenheit, formatTemperature will convert
          * the temperature. This method will also append either °C or °F to the temperature
          * String.
